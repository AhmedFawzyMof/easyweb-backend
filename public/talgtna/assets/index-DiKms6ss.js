    ...
    children: c.jsx(Cj, {
      ...
      children: e.map((o) =>
        c.jsx(
          ...
          {
            to: o.product
              ? `/talgtna/product/${o.product}`
              : `/talgtna/company/${o.company}`,
...
const OR = "/talgtna/assets/cart-BuiO4yb9.png";
function RR() {
  const e = tt((u) => u.cart),
